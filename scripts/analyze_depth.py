...
"""Analyze document link depths from entry points to all repo files.

Adapted from ~/source/standards/scripts/analyze_depth.py for gws-cli-notes.
Entry points: README.md, NOTES.md, CLAUDE.md
Depth constraint: NOTES.md must directly link every non-excluded content file.
"""
